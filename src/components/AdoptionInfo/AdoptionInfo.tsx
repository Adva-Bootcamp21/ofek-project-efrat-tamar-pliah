  ...
  return (
    <React.Fragment>
      ...
      <Popover
        ...
        disableRestoreFocus
      >
        <Alert severity="info">animals adopted so far
          : {adoptedIds?.allAdoptees.length} </Alert>
        <Alert style={{marginTop: '8px'}} severity="info">animals waiting for
          adoptions : {notAdoptedIds?.allAdoptees.length} </Alert>
      </Popover>
    </React.Fragment>
